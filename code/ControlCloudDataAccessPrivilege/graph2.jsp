...
String Keyupdated="Keyupdated";
 try
	...
	String sql="select count(status) from cloud where status='"+Keyupdated+"'";
...
String waiting="waiting";
 try
	...
	String sql1="select count(status) from cloud where status='"+waiting+"'";
